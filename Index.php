...
//     exit();
    $result='<div class="alert alert-danger">Email or password is incorrect, try again.</div>';
    echo $result;
}else{
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form class="user">
                                            ...
                                            <!-- <submit name="btnsubmit" id="btnsubmit" name="btnsubmit" class="btn btn-primary btn-user btn-block" >Login</submit> -->

                                            <input type="submit" name="btnsubmit" id="btnsubmit" name="btnsubmit" class="btn btn-primary btn-user btn-block">
                                            <!-- <hr>
